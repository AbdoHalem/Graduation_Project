        ...
        */
        ...
        SideGauge {
           ...
           /* Keys.onUpPressed: accelerating = true
            Keys.onDownPressed: accelerating = true
            Keys.onReleased: {
                if (event.key === Qt.Key_Up||event.key === Qt.Key_Down) {
                    accelerating = false;
                    event.accepted = true;
