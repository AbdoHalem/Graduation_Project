...
def check_driver_alertness(frame, face_detected, average_ear=None, yawn_ratio=None, sock=None):
...
def main():
    ...
    server_IP = "192.168.1.11"  # Change this to the server's IP address
    port = 1234
    try:
        ...
        while True:
            ...
            if ret:
                ...
                for face in faces_detected:
                    ...
                    check_driver_alertness(frame, face_detected, average_ear, yawn_ratio, sock)

                # Handle no-face case separately if no faces detected
                if not face_detected:
                    check_driver_alertness(frame, face_detected, sock=sock)
