...
interpreter = tf.lite.Interpreter(model_path="CNN_model.tflite")  # Update with your quantized model path
...
if __name__ == '__main__':
    ...
    for frame in clip.iter_frames():
        ...
        if frame_count % 10 == 0:
            last_status = road_lines_status(frame, update_model=True)
